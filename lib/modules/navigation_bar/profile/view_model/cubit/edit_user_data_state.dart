...
/// The problem is when I update both of the in the same session(application state)
...
/// are sent with it to api so it override the updated phone number and reverse
/// it's change back. is there is a solution to refresh the state directly
/// after updating one item without making an api call or any other solution?
//? When this state is triggered we will update GetUserDataSuccess state
